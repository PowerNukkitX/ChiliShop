...
public abstract class BaseConfig
{
	...
	private PluginTask<ChiliShop> saveTask;
	...
	{
		saveTask = new PluginTask<ChiliShop>(ChiliShop.ins)
		{
			@Override
		...
		if(this.synchronousSave || immediately)
		{
			...
			if(saveTask!=null)
			{
				...
				if(!saving)
				{
					...
					ChiliShop.server.getScheduler().scheduleTask(ChiliShop.ins, saveTask, true);
				}
			}
		}
