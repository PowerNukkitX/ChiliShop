...
public class PluginControlPanel extends FormWindowCustom implements FormResponse
{
	...
	public PluginControlPanel() 
	{
		super(Quick.t(LangNodes.cp_title,
				"PLUGIN_NAME",  ChiliShop.ins.getDescription().getName(),
				"CONFIG_VERSION", ChiliShop.ins.pluginConfig.version +"",
				"PLUGIN_VERSION", ChiliShop.ins.getDescription().getVersion()));

		convertToForm(ChiliShop.ins.pluginConfig);
	}
	...
	public void onFormResponse(PlayerFormRespondedEvent e) 
	{
		...
		try {
			...
			convertFromForm(ChiliShop.ins.pluginConfig, e);
		}catch (Exception ex){ex.printStackTrace();}

		ChiliShop.ins.pluginConfig.save();
	}
